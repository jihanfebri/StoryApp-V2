...
import com.example.story.view.story.IntentCameraActivity.Companion.CAMERA_RESULT
...
class StoryActivity : AppCompatActivity() {
    ...
    private val requestPermissionLauncher =
        registerForActivityResult(
            ...
            if (isGranted) {
                Toast.makeText(this, R.string.grantedPermission, Toast.LENGTH_LONG).show()
            } else {
                Toast.makeText(this, R.string.deniedPermission, Toast.LENGTH_LONG).show()
            }
        }
        ...
        currentImageUri?.let { uri ->
            ...
            viewModel.uploadImage(imageFile, description).observe(this) { result ->
                when (result) {
                    ...
                    is Results.Error -> {
                        binding.progressBar.visibility = View.GONE
                        Toast.makeText(this, R.string.emptyUpload, Toast.LENGTH_SHORT).show()
                    }
                    else -> {}
                }
            }
        } ?: showToast(R.string.emptyImages)
    }
